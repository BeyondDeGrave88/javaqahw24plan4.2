...
---
**Сценарий 4:** Переход через раздел "Популярные курсы" в нижней части главной страницы
#### Шаги:
...
**Ожидаемый результат:** Форма записи отображается на экране. Присутствуют поля "Имя", "Телефон", "Email", чекбоксы "Принимаю условия пользовательского соглашения" и "Хочу получать новости и актуальные предложения", и кнопка "Записаться".
...
**Ожидаемый результат:** Страница плавно прокручивается до блока с формой записи. Форма отображается на экране.
